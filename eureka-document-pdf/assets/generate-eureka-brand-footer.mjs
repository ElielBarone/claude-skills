...
export const buildEurekaFooter = () => {
  return `<div class="euk-footer-band">
  ${generateEurekaSvgSymbol({
    color: '#f5a623',
    className: 'euk-footer-symbol',
  }).trim()}
  <div class="euk-footer-contact">
    <svg class="euk-footer-contact-icon" width="14" height="14" viewBox="0 0 24 24">
  ...
  <div class="euk-footer-contact">
    <svg class="euk-footer-contact-icon" width="14" height="14" viewBox="0 0 24 24" fill="none">
